...
void moveP (string a, string b, int color)
{
    ...
    else if (abs(j2-j1) == 1  and  i2-i1 == (color==0 ? 1 : -1))
    {
        ...
        {
            eatenFig[ pole[8-i2][j2]/10 - 1][1-color]++;
            pole[8-i1][j1] = 0;
            pole[8-i2][j2] = 10 + color;
        }
...
void vivod()
{
    ...
    int nyyyyetoprostovremennyyFLAG1acho=0, nyyyyetoprostovremennyyFLAG2acho=0;
    for (i=0; i<6; i++)
    {
        nyyyyetoprostovremennyyFLAG1acho += eatenFig[i][0];
        nyyyyetoprostovremennyyFLAG2acho += eatenFig[i][1];
    }
    // куча ифов, вывод с окончаниями
    {
    cout << "Фигур съедено:" << endl;
    cout << "Белых:    ";
    if (nyyyyetoprostovremennyyFLAG1acho > 0)
    {
        if (eatenFig[0][0] > 0)
        {
            if (eatenFig[0][0] == 1)
                cout << "1 пешка  ";
            else if (eatenFig[0][0] < 5)
                cout << eatenFig[0][0] << " пешки  ";
            else
                cout << eatenFig[0][0] << " пешек  ";
        }
        if (eatenFig[1][0] > 0)
        {
            if (eatenFig[0][0] == 1)
    ...
    cout << endl;
    cout << "Чёрных:   ";
    if (nyyyyetoprostovremennyyFLAG2acho > 0)
    {
        if (eatenFig[0][1] > 0)
        {
            if (eatenFig[0][1] == 1)
                cout << "1 пешка  ";
            else if (eatenFig[0][1] < 5)
                cout << eatenFig[0][1] << " пешки  ";
            else
                cout << eatenFig[0][1] << " пешек  ";
        }
        if (eatenFig[1][1] > 0)
        {
            if (eatenFig[0][1] == 1)
