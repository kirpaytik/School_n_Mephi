...
short job_insert(Tree* tree, char* key, unsigned int info);
short job_delete(Tree* tree, char* key, short mode);
...
short job_find(Tree* tree, char* key, short mode,
    char** foundkey, unsigned int* amount, unsigned int** infos);
